...
namespace Vapps.Tests.MultiTenancy
{
    public class SubscriptionManagement_Tests : AppTestBase
    {
        ...
        public SubscriptionManagement_Tests()
        {
            ...
            _subscriptionPaymentManager = Resolve<ISubscriptionPaymentManager>();
        ...
        {
            var currentEdition = new SubscribableEditionCacheItem()
            {
            ...
            var targetEdition = new SubscribableEditionCacheItem()
            {
                DisplayName = "Premium",
                Name = "Premium",
            ...
            decimal price;
            price = _subscriptionPaymentManager.GetUpgradePrice(currentEdition, targetEdition, remainingDaysCount);
