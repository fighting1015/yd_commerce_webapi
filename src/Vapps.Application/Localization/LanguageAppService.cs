...
using Vapps.Localization.Dto;
using Microsoft.AspNetCore.Mvc;

namespace Vapps.Localization
{
    [AbpAuthorize(AdminPermissions.Configuration.Languages.Self)]
    public class LanguageAppService : VappsAppServiceBase, ILanguageAppService
    {
        ...
        /// <returns></returns>
        [AbpAuthorize(AdminPermissions.Configuration.Languages.Create, AdminPermissions.Configuration.Languages.Edit)]
        public async Task<GetLanguageForEditOutput> GetLanguageForEdit([FromQuery]NullableIdDto input)
        {
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [AbpAuthorize(AdminPermissions.Configuration.Languages.ChangeTexts)]
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [AbpAuthorize(AdminPermissions.Configuration.Languages.Create)]
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [AbpAuthorize(AdminPermissions.Configuration.Languages.Edit)]
