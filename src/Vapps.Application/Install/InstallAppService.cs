...
using Vapps.Migrations.Seed.Host;
...
namespace Vapps.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : VappsAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<VappsDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(VappsConsts.ConnectionStringName).Value.ToString();
        }
