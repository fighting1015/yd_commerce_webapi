...
using Vapps.Organizations.Dto;

namespace Vapps.Organizations
{
    [AbpAuthorize(AdminPermissions.UserManage.OrganizationUnits.Self)]
    public class OrganizationUnitAppService : VappsAppServiceBase, IOrganizationUnitAppService
    {
        ...
        /// <returns></returns>
        public async Task<PagedResultDto<OrganizationUnitUserListDto>> GetOrganizationUnitUsers([FromQuery]GetOrganizationUnitUsersInput input)
        {
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [AbpAuthorize(AdminPermissions.UserManage.OrganizationUnits.ManageOrganizationTree)]
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [AbpAuthorize(AdminPermissions.UserManage.OrganizationUnits.ManageMembers)]
