...
namespace Vapps.Editions
{
    public class EditionAppService : VappsAppServiceBase, IEditionAppService
    {
        ...
        /// 获取版本信息
        /// </summary>
        /// <param name="input">版本Id</param>
        /// <returns></returns>
        [AbpAuthorize(AdminPermissions.System.Editions.Create, AdminPermissions.System.Editions.Edit)]
        ...
        /// <param name="input">版本Id</param>
        /// <returns></returns>
        [AbpAuthorize(AdminPermissions.System.Editions.Delete)]
        ...
        /// <param name="onlyFreeItems">只获取免费版</param>
        /// <returns></returns>
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [AbpAuthorize(AdminPermissions.System.Editions.Create)]
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [AbpAuthorize(AdminPermissions.System.Editions.Edit)]
