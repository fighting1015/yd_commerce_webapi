...
using Vapps.Auditing.Exporting;
using Vapps.Authorization;
using Vapps.Authorization.Users;
using Vapps.Dto;
using EntityHistoryHelper = Vapps.EntityHistory.EntityHistoryHelper;

namespace Vapps.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AdminPermissions.System.Logs.AuditLogs.Self)]
    public class AuditLogAppService : VappsAppServiceBase, IAuditLogAppService
    {
