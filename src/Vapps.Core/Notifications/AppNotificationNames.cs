namespace Vapps.Notifications
{
    ...
    public static class AppNotificationNames
    {
        ...
        public const string DownloadInvalidImportOrders = "App.DownloadInvalidImportOrders";
        public const string DownloadInvalidImportShipments = "App.DownloadInvalidImportShipments";
    }
}